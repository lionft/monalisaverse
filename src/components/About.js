    ...
    <>
      ...
      >
        <div className='grid sm:grid-cols-12 items-center'>
          ...
          <div
            className='row-start-1 sm:row-start-auto sm:pl-16 sm:text-left lg:col-span-6 pl-'
            data-aos='fade-left'
            data-aos-duration='1000'
          >
        ...
        >
          <div className='grid sm:grid-cols-12 items-center'>
            ...
            <div
              className='mt-5 sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center'
              data-aos='fade-left'
              data-aos-duration='600'
            >
              <div className='flex-shrink-0 w-full'>
