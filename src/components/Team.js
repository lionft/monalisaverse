...
import teamImage1 from '../images/team/1.jpeg';
import teamImage2 from '../images/team/2.jpeg';
import teamImage3 from '../images/team/3.jpeg';
import teamImage4 from '../images/team/4.jpeg';
              ...
              <div className='space-y-3 xl:space-y-4'>
                ...
                <div className='space-y-2 xl:flex xl:justify-between'>
                  <div className='font-medium text-lg leading-6 space-y-1'>
                    <h3 className='text-white uppercase text-sm sm:text-xl font-bold text-default'>
                      Angel Investor
                    </h3>
                  </div>
                  <ul className='flex justify-center space-x-2 sm:space-x-2'>
                    <li>
                      <a
                        href='https://instagram.com/alleielli?utm_medium=copy_link'
              ...
              <div className='space-y-3 xl:space-y-4'>
                ...
                <div className='space-y-2 xl:flex xl:justify-between'>
                  ...
                  <ul className='flex justify-center space-x-2 sm:space-x-2'>
                    <li>
                      <a
                        href='https://www.instagram.com/mariochianese791/'
                        className='block p-1 bg-white rounded-full hover:ring-2 hover:ring-primary'
                      >
                        <span className='sr-only'>Instagram</span>
                        <svg
              ...
              <div className='space-y-3 xl:space-y-4'>
                ...
                <div className='space-y-2 xl:flex xl:justify-between'>
                  ...
                  <ul className='flex justify-center space-x-2 sm:space-x-2'>
                    <li>
                      <a
                        href='https://www.instagram.com/santoholyshit/'
                        className='block p-1 bg-white rounded-full hover:ring-2 hover:ring-primary'
                      >
                        <span className='sr-only'>Instagram</span>
                        <svg
              ...
              <div className='space-y-3 xl:space-y-4'>
                ...
                <div className='space-y-2 xl:flex xl:justify-between'>
                  ...
                  <ul className='flex justify-center space-x-2 sm:space-x-2'>
                    <li>
                      <a
                        href='https://instagram.com/skit_graphic?utm_medium=copy_link'
                        className='block p-1 bg-white rounded-full hover:ring-2 hover:ring-primary'
                      >
                        <span className='sr-only'>Instagram</span>
                        <svg
